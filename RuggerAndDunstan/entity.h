...
namespace entityNS
{
    ...
    const float GRAVITY = 2.67428e-11f;         // gravitational constant
}
...
class Entity : public Image
{
  ...
  public:
	...
	virtual void  setActiveAndVisible(bool a){active = a; visible = a;}
	virtual void  setVisibleAndActive(bool a){active = a; visible = a;}
