...
class Image
{
  ...
  public:
    ...
    // Return center X.
    virtual float getCenterX() const      {return spriteData.x + spriteData.width/2*getScale();}

    // Return center Y.
    virtual float getCenterY() const      {return spriteData.y + spriteData.height/2*getScale();}
